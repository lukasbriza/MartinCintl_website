    ...
    return(
        <div id="socialIcons-wrapper">
            <div id="socialIcons-section">
                <MailSmallIcon id="mailIcon" size={props.size} to={"xxx"}/>
                <InstagramSmallIcon id="instagramIcon" size={props.size} to={"xxx"}/>
                <FacebookSmallIcon id="facebookIcon" size={props.size} to={"xxx"}/>
            </div>
            <div id="mobileclicker">
            </div>
        </div>
    )
}
...
function InstagramSmallIcon(props: socialIcon) {
  return (
    <Link id="instagram-background" to={props.to} className="icon">
      <svg
        height={props.size}
...
function FacebookSmallIcon(props: socialIcon) {
    return (
      <Link id="facebook-background" to={props.to} className="icon">
        <svg
          height={props.size}
          viewBox="0 0 24 24"
          width={props.size}
